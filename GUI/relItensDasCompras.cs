...
namespace GUI
{
    public partial class relItensDasCompras : Form
    {
        public int codigo = 0;
        public relItensDasCompras()
        {
            InitializeComponent();
        }
        ...
        private void dgvDados_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                this.itenscompraTableAdapter.cod(this.bd_tccDataSet.itenscompra, Convert.ToInt32(dgvDados.Rows[e.RowIndex].Cells[0].Value));
