   ...
   public class ModeloFornecedor
    {
        ...
        //Fortipo valor 0=pessoa fissica ,valor 1 juridica
        //contrutores
        ...
        public ModeloFornecedor(int cod, string nome, string cpfcnpj, string rgie, string rsocial, string cep,
        ...
        private string For_ennumero;
        public string ForEndNumero
        {
            get { return this.For_ennumero; }
            set { this.For_ennumero = value; }
        }
