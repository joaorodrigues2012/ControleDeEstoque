  ...
  public class ModeloCliente
    {
        ...
        public ModeloCliente(int cod,string nome,string cpfcnpj,string rgie, string rsocial, string tipo, string cep, 
        ...
        private string cli_ennumero;
        public string CliEndNumero
        {
            get { return this.cli_ennumero; }
            set { this.cli_ennumero = value; }
        }
